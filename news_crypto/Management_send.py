...
def send_subs_management_email_to_user(recipient_email):
    ...
    subject = "Manage Your Crypto & Blockchain Newsletter Subscription!"

    # Contact information
    contact = {
        "contact_phone": os.environ.get("CONTACT_PHONE", "+352 661777082"),
        "contact_mail": os.environ.get("CONTACT_EMAIL", "info@homesmartify.lu"),
        "contact_web": os.environ.get("CONTACT_WEB", "www.homesmartify.lu")
    }

    # Build subscription management link
    manage_link = f"https://www.ainewsletter.homesmartify.lu/crypto/management/?email={recipient_email}"
    ...
    # Plain text fallback
    text_part = MIMEText("Manage your Crypto & Blockchain Newsletter", 'plain')
    ...
    <head>
      ...
      <title>Manage Your Crypto & Blockchain Newsletter</title>
      <style type="text/css">
        :root {{
              ...
              <tr>
                <td align="center" style="padding:20px;">
                  ...
                  <div class="content-box">
                    ...
                    <p class="intro-text">
                      Thank you for being part of our Crypto & Blockchain community! Stay ahead of the curve with our curated insights into cryptocurrency, blockchain technology, and digital assets. You can easily manage your subscription preferences or unsubscribe using the link below:
                      <br>
                      <a href="{manage_link}" target="_blank" class="manage-link">Manage Your Subscription</a>
                    </p>
                  </div>
                  ...
                  <div style="text-align:center; font-size:12px; color:var(--footer-color); margin-top:15px; background:transparent;">
                    ...
                    Your Gateway to Crypto & Blockchain Insights<br>
    ...
    try:
        with smtplib.SMTP(smtp_server, smtp_port) as server:
            ...
            print(f"[DEBUG] Sent management email to {recipient_email}")
    except Exception as e:
...
if __name__ == "__main__":
    load_dotenv()
    test_email = "yagebin79386@gmail.com"  # Replace with your test email
