...
def send_welcome_email_to_user(recipient_email):
    ...
    sender_password = os.environ.get("SMTP_PASSWORD")  # Updated to use correct env var name
    subject = "Welcome to Crypto & Blockchain Newsletter!"
    ...
    # Contact information
    contact = {
        "contact_phone": os.environ.get("CONTACT_PHONE", "+352 1234567"),
    ...
    # Plain text fallback
    text_part = MIMEText("Welcome to our Crypto & Blockchain Newsletter.", 'plain')
    ...
    <head>
      ...
      <title>Welcome to Crypto & Blockchain Newsletter</title>
      <style type="text/css">
        :root {{
              ...
              <tr>
                <td align="center" style="padding:20px;">
                  ...
                  <table width="100%" style="background:var(--box-bg); border-radius:12px; padding:20px;">
                    <tr>
                      <td align="center" class="newsletter-title">
                        WELCOME TO CRYPTO & BLOCKCHAIN NEWSLETTER
                      </td>
                    </tr>
                  </table>
                  <!-- INTRO AREA -->
                  <div class="content-box">
                    ...
                    <p class="intro-text">
                      Thank you for subscribing to our Crypto & Blockchain newsletter. We're excited to share the latest insights, trends, and news on digital currencies, blockchain innovations, and decentralized finance.
                    </p>
                    <p class="intro-text">
