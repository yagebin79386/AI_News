...
if os.environ.get('RUNNING_IN_PRODUCTION') == 'true':
    app.config['APPLICATION_ROOT'] = '/ai/newsletter'
    logger.info("Running in production mode with APPLICATION_ROOT set to /ai/newsletter")
else:
...
def index():
    ...
    <body>
        ...
        <p>Example: <a href="/ai/newsletter/1">/ai/newsletter/1</a> to view newsletter #1</p>
    </body>
    </html>
    """
